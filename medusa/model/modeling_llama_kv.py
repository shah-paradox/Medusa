...
# Compatibility shim: is_flash_attn_available was removed in transformers >=4.36
try:
...
def _patch_config_defaults(config):
    ...
    Older model configs (e.g., LLaMA v1 / Vicuna v1.3) may lack attributes
    that were added in later versions of LlamaConfig. This patches in the
    defaults that were present in transformers v4.34.
    """
...
class LlamaAttention(nn.Module):
    ...
    def _init_rope(self):
        ...
        # Compatibility: newer transformers uses "rope_type" key instead of "type",
        # and sets rope_scaling={"rope_type": "default"} instead of None.
